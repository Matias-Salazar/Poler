...
<body>
    ...
    <main>
        <div class="grid grid-center form-container">
            <div class="bg"></div>
            <div class="col-5_sm-12_md-12_xs-10 form-wrapper">
                ...
                <div class="grid">
                    ...
                    <div class="col form-group form-row">
                        <div class="form-item">
                            ...
                            <input type="text" name="lastname" id="lastname" placeholder="Apellido" alue="<?= (isset($_POST['lastname'])) ? $_POST['lastname'] :'';?>">
                            <span><i class="fa fa-user" aria-hidden="true"></i></span>
                        </div>
                    ...
                    <div class="col-12 form-group">
                        <div class="form-item">
                            ...
                            <input type="email" name="email" id="email" placeholder="Email" alue="<?= (isset($_POST['email'])) ? $_POST['email'] :'';?>">
                    ...
                    <div class="col-8 grid-spaceBetween register-btn" data-push-left="off-2">
                        <input type="submit" name="submit" value="Registrarse" id="registerBtn" class="btn-principal btn-register">
                    </div>
                </div>
            </form>
        </div>
