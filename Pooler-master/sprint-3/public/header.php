 <nav class="grid">
    ...
    <ul class="col-7_xs-11 menu">
        <li><a class="nav-link" href="<?php if ($_SERVER['PHP_SELF'] == '/index.php')  {echo "#hero";} else {echo "index.php#hero";} ?>" target="#hero">¿Qué es?</a></li>
        <li><a class="nav-link" href="<?php if ($_SERVER['PHP_SELF'] == '/index.php')  {echo "#how-works";} else {echo "index.php#how-works";} ?>" target="#how-works">¿Cómo funciona?</a></li>
